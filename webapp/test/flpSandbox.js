		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Project Estudos",
									"targetURL": "#ProrectEstudos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ProrectEstudos-display": {
								"semanticObject": "ProrectEstudos",
								"action": "display",
								"description": "A Fiori application.",
								"title": "Prorect Estudos",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									"applicationType": "SAPUI5",
									"additionalInformation": "SAPUI5.Component=pws.ce.projectestudos210629",
									"url": sap.ui.require.toUrl("pws/ce/projectestudos210629")
								}
							}
						}
					}
