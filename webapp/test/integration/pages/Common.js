sap.ui.define([
	...
	return Opa5.extend("pws.ce.projectestudos210629.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["pws/ce/projectestudos210629/localService/mockserver"], function (mockserver) {
