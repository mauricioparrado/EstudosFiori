sap.ui.define([
	...
	return BaseController.extend("pws.ce.projectestudos210629.controller.Worklist", {
		...
		onInit : function () {
			...
			console.log("pesquisa resourse",this.getResourceBundle().getText("worklistTableTitle"));
			...
			console.log("modelo pagina Worklist", oModelo);
		},
		...
		onPressPagina: function(oEvent) {
			console.log('Click onPressPagina:',oEvent);
		...
		onPressFragment : function () {
			...
			if (!this.pDialog) {
				this.pDialog = Fragment.load({
					id: oView.getId(),
					name: "pws.ce.projectestudos210629.view.Teste",
					controller: this
		...
		onCloseFragmentDialog: function () {
			console.log("estou fechando a tela");
